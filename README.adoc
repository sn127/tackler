...
* Strict account name validation with link:./accounts.conf[Chart of Accounts]
* Reports (link:./report-balance.adoc[Balance], link:./report-balance-group.adoc[Balance Groups], link:./report-register.adoc[Register])
* Exports (link:./report-equity.adoc[Equity], link:./report-identity.adoc[Identity])
