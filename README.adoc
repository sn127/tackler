...
image:http://javadoc.io/badge/fi.sn127/tackler-core_2.12.svg?color=blue["javadoc", link="http://javadoc.io/doc/fi.sn127/tackler-core_2.12"]
...
* Text and link:docs/tep/tep-1004.adoc[JSON] output formats for reports
* Has good performance with link:docs/performance.adoc[very large set of transactions]
...
** With large set of transactions Tackler is faster than link:docs/perf-others.adoc[ledger-cli or other similar tools]
...
Tackler-core, which is supposed to be usable to use as separate component,
is released on Maven Central Repository.

Dependency setting for SBT is:
